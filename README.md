...
- Redeploy on **Amazon ECS/Fargate** or **SageMaker** for additional cloud orchestration experience.
- Add **model monitoring** for data drift and prediction distribution.
